    ...
    <IonPage>
      <IonContent className="ion-padding">
              ...
              */}
                        ...
                        {/* Inputs de login */}
                        {/* Inputs de login */}
                        <div className="form" style={{ zIndex: '9999', padding: '0', width: '100%' }}>
                        <div style={{ width: '100%'}}>
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '10px', outline: 'none'}}>
                            ...
                            <label className="custom-label" style={{ marginTop: '15px', color: '#6B7888', fontFamily: 'Poppins', fontSize: '14px', fontStyle: 'normal', fontWeight: '400', lineHeight: '20px' }}>E-mail ou CPF</label>
                            </div>
                              <IonInput
                                type="text"
                        ...
                        <div className="custom-content-hr">
                          <svg xmlns="http://www.w3.org/2000/svg" width="75" height="2" viewBox="0 0 75 2" fill="#E2E2E2">
                            <path d="M1 1H74" stroke="#E2E2E2" stroke-width="1.5" stroke-linecap="round" />
                          </svg>
                          <p className="custom-p-hr" style={{ textAlign: 'center', color: 'gray' }}>Suporte para login</p>
                          <svg xmlns="http://www.w3.org/2000/svg" width="75" height="2" viewBox="0 0 75 2" fill="#E2E2E2">
                            <path d="M1 1H74" stroke="#E2E2E2" stroke-width="1.5" stroke-linecap="round" />
                          </svg>
                        </div>
                        ...
                        <div>
                          <p className="custom-not-account">Ainda não tem uma conta?<a href="/register" className="custom-not-account-span">Clique aqui</a></p>
                        </div>
                      </div>
