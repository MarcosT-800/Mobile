            ...
            <IonPage>
                ...
                {showSpinner ? (
                    ...
                    <div className="custom-content">
                        <img src="/error6.png" style={{ marginTop: '-200px'}}/>
                                <h3 style={{ color: "#111", textAlign: "center", marginTop: '', fontSize: '24px', fontStyle: 'normal', fontWeight: '500', lineHeight: 'normal' }}>
                                    Você já possui uma operação em andamento, verifique o status de sua proposta em nosso aplicativo na aba contratos.
                                </h3>
