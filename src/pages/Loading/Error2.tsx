        ...
        <IonPage>
            ...
            {showSpinner ? (
                    ...
                    <div className="custom-content" style={{ heigth: 'auto' }}>
                        <img src="/error2atualizado.png" alt="Logo" style={{ marginTop: '450px' }} />
                            <h3 style={{ color: "#111", textAlign: "center", marginTop: '', fontSize: '24px', fontStyle: 'normal', fontWeight: '500', lineHeight: 'normal' }}>
                                Não é possível antecipar antes dessa data!
                            </h3>

                            <p style={{ color: "#838282", textAlign: "center", marginTop: '0px', fontFamily: 'Poppins', fontSize: '16px', fontStyle: 'normal', fontWeight: '400', lineHeight: 'normal', paddingRight: '20px', paddingLeft: '20px' }}>Porque isso acontece? <br style={{ marginTop: '10px' }} /> <p>Você já está no período do seu aniversário devido a isso a caixa não permite a simulação volte após esse período e a simulação irá funcionar normalmente!</p></p>
                            ...
                            <Link to="/simulation3">
                                <button  className="custom-button-modal1" style={{ marginTop: 20, fontSize: "16px", fontWeight: "bold" }}>
                                    Tentar novamente
                                </button>
                            </Link>
                    </div>
