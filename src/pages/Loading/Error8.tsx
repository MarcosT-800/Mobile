            ...
            <IonPage>
                ...
                {showSpinner ? (
                    ...
                    <div className="custom-content">
                        <img src="/error8.png" style={{ marginTop: '-200px'}}/>
                                <h3 style={{ color: "#111", textAlign: "center", marginTop: '', fontSize: '24px', fontStyle: 'normal', fontWeight: '500', lineHeight: 'normal' }}>
                                    Desculpe houve um erro interno em nosso servidor tente novamente!
                                </h3>

                                <p style={{ color: "#838282", textAlign: "center", marginTop: '0px', fontFamily: 'Poppins', fontSize: '16px', fontStyle: 'normal', fontWeight: '400', lineHeight: 'normal', paddingRight: '20px', paddingLeft: '20px' }}>Erro interno no servidor do aplicativo, tente simular novamente caso persita tente novamente mais tarde ou entre em contato conosco!</p>
