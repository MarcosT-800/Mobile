...
function Loading2() {
    ...
    const totalCards = 2; // Número total de cards
                                    ...
                                    >
                                        {[...Array(totalCards)].map((_, index) => (
                                            <div className="carousel-card" key={index}>
                                                <img alt={`Card ${index + 11}`} src={`/${index + 11}.png`} style={{ height: '100%' }} />
                                            </div>
                                        ))}
                                    </div>
                                </div>
